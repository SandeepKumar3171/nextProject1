             ...
             <div className='flex md:flex-row  flex-col justify-between gap-5 w-full'>
                ...
                <div className='flex flex-col gap-10 items-center justify-center text-lg w-full'>
                    <div className='flex md:flex-row flex-col gap-5 items-center'>
                        <Image className='md:w-1/2 w-screen h-fit' src="/about_glowips_delhi.jpg" width="170" height="170"></Image>
            ...
            <div className='flex md:flex-row flex-col justify-between gap-5 w-full'>
                <div className='flex flex-col gap-10  border-2 border-blue-600 w-full md:w-1/2 text-lg'>
                    ...
                    '>
                        ...
                        <button className='flex items-center justify-center bg-blue-600 text-white rounded-lg w-fit p-5 text-center ml-10 m-2 h-12'>Send Messages</button>
                    </div>
                </div>
